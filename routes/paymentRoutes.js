...
import  {checkoutSuccess, createCheckout, createPayment, getPaymentById} from '../controllers/paymentController.js';
...
paymentRouter.post('/paysuccess',authenticateUser,checkoutSuccess)
